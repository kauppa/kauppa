...
GRANT CREATE,SELECT,INSERT,UPDATE ON DATABASE kauppa_accounts TO kauppa_accounts;
GRANT CREATE,SELECT,INSERT,UPDATE ON DATABASE kauppa_cart TO kauppa_cart;
GRANT CREATE,SELECT,INSERT,UPDATE ON DATABASE kauppa_coupon TO kauppa_coupon;
GRANT CREATE,SELECT,INSERT,UPDATE ON DATABASE kauppa_orders TO kauppa_orders;
